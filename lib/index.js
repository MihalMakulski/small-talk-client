const socket = require('socket.io-client')('http://localhost:3000')/*('https://m-small-talk.herokuapp.com/')*/;
...
process.on('exit', (code) => {
  console.log(`${colors.FgMagenta}Name is required, dude! And it can't be "admin".${resetColor}`);
});
